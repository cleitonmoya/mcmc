...
z_theta01 <- unname(geweke.diag(theta_01_hist[-(1:burnin)], frac1=0.1, frac2=0.5)[[1]])
z_theta02 <- unname(geweke.diag(theta_02_hist[-(1:burnin)], frac1=0.1, frac2=0.5)[[1]])
printf("\tz_theta01: %.2f", z_theta01)
printf("\tz_theta02: %.2f", z_theta02)
