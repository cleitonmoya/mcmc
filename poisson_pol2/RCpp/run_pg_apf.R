# Driver R para o amostrador PG-APF implementado em C++/Rcpp (pg_apfB.cpp)
# Mantém a mesma configuração/carregamento de dados e o mesmo pós-processamento
# (ESS, Geweke, gráficos) do script original pg_apfB.R — apenas o laço de
# Gibbs passa a rodar em C++.

library(Rcpp)
library(coda)
sourceCpp("pg_apf.cpp")
