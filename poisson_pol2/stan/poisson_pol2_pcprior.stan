...
parameters {
  ...
  real theta_01;            // theta_01 (estado inicial)
  real theta_02;            // theta_02

  real<lower=0> sigma_W1;   // phi = 1/W1 (precisão do sistema)
  real<lower=0> sigma_W2;   // phi = 1/W2 (precisão do sistema)
}
