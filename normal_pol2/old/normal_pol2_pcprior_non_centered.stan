...
transformed parameters {
  ...
  theta1[1] = theta_01 + theta_02 + sigma_W1 * eta1[1];
  theta2[1] = theta_02            + sigma_W2 * eta2[1];

  for (t in 2:T) {
    theta1[t] = theta1[t-1] + theta2[t-1] + sigma_W1 * eta1[t];
    theta2[t] = theta2[t-1]               + sigma_W2 * eta2[t];
  }
